...
Chrome/Edge 浏览器插件，用于从网页图片、本地图片或多张参考图中反推结构化 AI 生成提示词，并支持 **Nano Banana Pro / Midjourney V8.1 双引擎提示词助手**、多模板切换、中文 Prompt 预览、JSON 编辑、自然语言修改、多图参考、历史恢复参考图和 OpenAI 兼容网关配置。
...
- **双引擎提示词助手**：输入中文想法、参考图、画幅和限制条件，生成 Nano Banana Pro 或 Midjourney V8.1 可直接复制的英文提示词，并提供中文核对。
